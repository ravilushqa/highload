...
func (x *FlushChatCounterRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *FlushChatCounterRequest) GetChatId() int64 {
	if x != nil {
		return x.ChatId
	}
	return 0
...
type CountersClient interface {
	...
	FlushChatCounter(ctx context.Context, in *FlushChatCounterRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *countersClient) FlushChatCounter(ctx context.Context, in *FlushChatCounterRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type CountersServer interface {
	...
	FlushChatCounter(context.Context, *FlushChatCounterRequest) (*empty.Empty, error)
}
...
func (*UnimplementedCountersServer) FlushChatCounter(context.Context, *FlushChatCounterRequest) (*empty.Empty, error) {
